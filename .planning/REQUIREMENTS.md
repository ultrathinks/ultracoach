...
- [ ] **DASH-01**: Overview 페이지에서 통계 카드, 점수 추이, 최근 세션 요약을 한눈에 볼 수 있다
- [ ] **DASH-02**: 면접 기록 페이지에서 전체 세션 목록과 유형별 비교 차트를 볼 수 있다
- [ ] **DASH-03**: 약점 분석 페이지에서 STAR 레이더, 바디랭귀지, 추임새 히트맵을 볼 수 있다
- [ ] **DASH-04**: 액션 플랜 페이지에서 액션 트래커와 AI 추천을 볼 수 있다
